...
package body Page_Rank_Matrices_creuses is

    procedure Page_Rank_creuse(Nom_Fichier : in Unbounded_String; Nom_Fichiers_Produits : in Unbounded_String; alpha :in T_Reel; Nb_Iterations : in Integer; Epsilon : in T_Reel; Nb_Noeuds :in Integer) is

        package Matrices_Creuses_Instanciee is new Matrices_Creuses (N => Nb_Noeuds);
        use Matrices_Creuses_Instanciee;
    ...
    begin
        ...
        --Rendre la somme des elements d'une ligne de H egale a 1
        ...
        loop
            ...
            V_pi_0 := V_pi;
            V_pi := calcul_vecteur_poids( H,alpha, E, V_pi );
