...
procedure test_TH is
    ...
    package TH_String_Integer is
            new TH (T_Cle => Unbounded_String, T_Valeur => Integer, Capacite=>11, fonction_de_hachage=>fonction_de_hachage);
    ...
    procedure Construire_Exemple_Sujet (Annuaire : out T_Tableau; Bavard: Boolean := False) is
    begin
