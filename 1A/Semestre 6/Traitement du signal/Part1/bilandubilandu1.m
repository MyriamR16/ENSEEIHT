...
%semilogy(rabbtab, tebtab, 'o');
%hold on
Qtab3 = (3/4)*qfunc(sqrt((4/5)*10.^(rabbtab/10)));
%semilogy(rabbtab, Qtab3, 'o');
%grid on;
%axis padded;

semilogy(rabbtab, Qtab1, 'o-g');
hold on;
semilogy(rabbtab, Qtab2, 'o-b');
hold on;
semilogy(rabbtab, Qtab3, 'o-r');
hold on;
plot (rabbtab, 10^(-3)*ones(length(rabbtab)), 'k');
axis padded;