...
public class StrategiePhiloPremiereApprocheSansInterblocage implements StrategiePhilo {

    /****************************************************************/
    private Semaphore[] fourchettes;

    public StrategiePhiloPremiereApprocheSansInterblocage (int nbPhilosophes) {
    ...
    public void demanderFourchettes (int no) throws InterruptedException
    {
        ...
        Thread.sleep(400);
        if (!this.fourchettes[fg].tryAcquire()) {
