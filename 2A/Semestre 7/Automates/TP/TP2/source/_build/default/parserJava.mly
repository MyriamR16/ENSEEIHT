...
instructions : { (print_endline "instructions : Liste d'instructions vide */") } 
...
instruction : expression PTVIRG { (print_endline "instruction : expression PTVIRG") }
			| SI PAROUV expression PARFER bloc { (print_endline "instruction : SI (expression) bloc") }
			| SI PAROUV expression PARFER bloc SINON bloc { (print_endline "instruction : SI (expression) bloc SINON bloc ") }
			| TANTQUE PAROUV expression PARFER bloc { (print_endline "instruction : TANTQUE (expression) bloc") }
...
expressions : ENTIER { (print_endline "expression : ENTIER") }
			...
			| IDENT suffixeBoucle { (print_endline "expression : ident suffixeBoucle") }
			| PAROUV expression PARFER suffixeBoucle  { (print_endline "expression : (expression) suffixeBoucle") }

expression : unaireBoucle expressions binaireBoucle{}

suffixeBoucle : /* Lambda, mot vide */ {(print_endline "suffixeBoucle : vide */")}
				| suffixe suffixeBoucle {}

unaireBoucle : /* Lambda, mot vide */ {(print_endline "unaireBoucle : vide */")}
				| unaire unaireBoucle {}

binaireBoucle : /* Lambda, mot vide */ {(print_endline "binaireBoucle : vide */")}
				| binaire expression binaireBoucle {}

binaire : ASSIGN {}| OPPT {}| OPPLUS {}| OPMOINS {}| OPMULT {}| OPDIV {}| OPMOD {}| OPOU {}
		| OPET {}| OPEG {}| OPNONEG {}| OPINF {}| OPSUP {}| OPINFEG {}| OPSUPEG {}


unaire : OPNON {}| OPPLUS {}| OPMOINS {}| PAROUV typeStruct PARFER {}

suffixe : CROOUV expression CROFER { (print_endline "suffixe : [expression] ") }
		| PAROUV expressionSuffixe PARFER { (print_endline "suffixe : (expression ...)") }

expressionSuffixe : expression {}
				|expression VIRG expressionSuffixe {}
