...
public class NoeudItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addEntrantPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Entrant feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addEntrantPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Noeud_entrant_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Noeud_entrant_feature", "_UI_Noeud_type"),
				 PetriNetPackage.Literals.NOEUD__ENTRANT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSortantPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Noeud_sortant_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Noeud_sortant_feature", "_UI_Noeud_type"),
				 PetriNetPackage.Literals.NOEUD__SORTANT,
				 true,
				 false,
				 true,
				 null,
