	...
	protected void addDestinationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arc_destination_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arc_destination_feature", "_UI_Arc_type"),
				 PetriNetPackage.Literals.ARC__DESTINATION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLinkTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arc_linkType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arc_linkType_feature", "_UI_Arc_type"),
				 PetriNetPackage.Literals.ARC__LINK_TYPE,
				 true,
				 false,
				 false,
