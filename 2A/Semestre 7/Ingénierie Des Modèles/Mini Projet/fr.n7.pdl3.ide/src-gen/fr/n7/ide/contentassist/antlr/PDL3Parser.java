...
public class PDL3Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PDL3GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getProcessAccess().getWorkDefinitionAssignment_3(), "rule__Process__WorkDefinitionAssignment_3");
			builder.put(grammarAccess.getProcessAccess().getWorkSequenceAssignment_5(), "rule__Process__WorkSequenceAssignment_5");
