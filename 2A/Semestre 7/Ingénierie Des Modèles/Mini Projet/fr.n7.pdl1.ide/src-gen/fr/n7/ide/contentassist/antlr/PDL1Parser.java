...
public class PDL1Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PDL1GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getOccurrenceAccess().getGroup(), "rule__Occurrence__Group__0");
			...
			builder.put(grammarAccess.getWorkDefinitionAccess().getOccurrencesAssignment_2(), "rule__WorkDefinition__OccurrencesAssignment_2");
			...
			builder.put(grammarAccess.getRessourceAccess().getQuantiteAssignment_2(), "rule__Ressource__QuantiteAssignment_2");
			builder.put(grammarAccess.getOccurrenceAccess().getOccurrenceAssignment_1(), "rule__Occurrence__OccurrenceAssignment_1");
			builder.put(grammarAccess.getOccurrenceAccess().getRessourceUtileAssignment_2(), "rule__Occurrence__RessourceUtileAssignment_2");
			builder.put(grammarAccess.getOccurrenceAccess().getWdAssocieeAssignment_3(), "rule__Occurrence__WdAssocieeAssignment_3");
		}
	}
