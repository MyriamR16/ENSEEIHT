...
public class PDL1PackageImpl extends EPackageImpl implements PDL1Package
{
   ...
   */
  @Override
  public EReference getWorkDefinition_Occurrences()
  {
   ...
   */
  @Override
  public EReference getOccurrence_RessourceUtile()
  {
   ...
   */
  @Override
  public EReference getOccurrence_WdAssociee()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(workDefinitionEClass, WORK_DEFINITION__OCCURRENCES);
    ...
    createEReference(occurrenceEClass, OCCURRENCE__RESSOURCE_UTILE);
    createEReference(occurrenceEClass, OCCURRENCE__WD_ASSOCIEE);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getWorkDefinition_Occurrences(), this.getOccurrence(), null, "occurrences", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getOccurrence_Occurrence(), ecorePackage.getEInt(), "occurrence", null, 0, 1, Occurrence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOccurrence_RessourceUtile(), this.getRessource(), null, "ressourceUtile", null, 0, 1, Occurrence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOccurrence_WdAssociee(), this.getWorkDefinition(), null, "wdAssociee", null, 0, 1, Occurrence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
