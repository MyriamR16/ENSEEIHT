...
public class PDL1GrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class WorkDefinitionElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cNameAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cNameIDTerminalRuleCall_1_0 = (RuleCall)cNameAssignment_1.eContents().get(0);
		private final Assignment cOccurrencesAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cOccurrencesOccurrenceParserRuleCall_2_0 = (RuleCall)cOccurrencesAssignment_2.eContents().get(0);
		...
		//occurrences+=Occurrence*
		public Assignment getOccurrencesAssignment_2() { return cOccurrencesAssignment_2; }
		
		//Occurrence
		public RuleCall getOccurrencesOccurrenceParserRuleCall_2_0() { return cOccurrencesOccurrenceParserRuleCall_2_0; }
	}
	...
	public class RessourceElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cRessKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cNameAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cNameIDTerminalRuleCall_1_0 = (RuleCall)cNameAssignment_1.eContents().get(0);
		...
		//'ress'
		public Keyword getRessKeyword_0() { return cRessKeyword_0; }
	...
	public class OccurrenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.n7.PDL1.Occurrence");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cOccKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cOccurrenceAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cOccurrenceINTTerminalRuleCall_1_0 = (RuleCall)cOccurrenceAssignment_1.eContents().get(0);
		private final Assignment cRessourceUtileAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final CrossReference cRessourceUtileRessourceCrossReference_2_0 = (CrossReference)cRessourceUtileAssignment_2.eContents().get(0);
		private final RuleCall cRessourceUtileRessourceIDTerminalRuleCall_2_0_1 = (RuleCall)cRessourceUtileRessourceCrossReference_2_0.eContents().get(1);
		private final Assignment cWdAssocieeAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final CrossReference cWdAssocieeWorkDefinitionCrossReference_3_0 = (CrossReference)cWdAssocieeAssignment_3.eContents().get(0);
		private final RuleCall cWdAssocieeWorkDefinitionIDTerminalRuleCall_3_0_1 = (RuleCall)cWdAssocieeWorkDefinitionCrossReference_3_0.eContents().get(1);
		...
		//'occ'
		public Keyword getOccKeyword_0() { return cOccKeyword_0; }
		
		//occurrence=INT
		public Assignment getOccurrenceAssignment_1() { return cOccurrenceAssignment_1; }
		
		//INT
		public RuleCall getOccurrenceINTTerminalRuleCall_1_0() { return cOccurrenceINTTerminalRuleCall_1_0; }
		
		//ressourceUtile=[Ressource]
		public Assignment getRessourceUtileAssignment_2() { return cRessourceUtileAssignment_2; }
		
		//[Ressource]
		public CrossReference getRessourceUtileRessourceCrossReference_2_0() { return cRessourceUtileRessourceCrossReference_2_0; }
		
		//ID
		public RuleCall getRessourceUtileRessourceIDTerminalRuleCall_2_0_1() { return cRessourceUtileRessourceIDTerminalRuleCall_2_0_1; }
		
		//wdAssociee=[WorkDefinition]
		public Assignment getWdAssocieeAssignment_3() { return cWdAssocieeAssignment_3; }
		
		//[WorkDefinition]
		public CrossReference getWdAssocieeWorkDefinitionCrossReference_3_0() { return cWdAssocieeWorkDefinitionCrossReference_3_0; }
		
		//ID
		public RuleCall getWdAssocieeWorkDefinitionIDTerminalRuleCall_3_0_1() { return cWdAssocieeWorkDefinitionIDTerminalRuleCall_3_0_1; }
	}
	...
	private final OccurrenceElements pOccurrence;
	...
	public PDL1GrammarAccess(GrammarProvider grammarProvider,
		...
		this.pOccurrence = new OccurrenceElements();
