 ...
 *   <li>{@link fr.n7.pDL1.impl.WorkDefinitionImpl#getOccurrences <em>Occurrences</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition
{
  ...
  public EList<Occurrence> getOccurrences()
  {
    if (occurrences == null)
    {
      occurrences = new EObjectContainmentEList<Occurrence>(Occurrence.class, this, PDL1Package.WORK_DEFINITION__OCCURRENCES);
    }
    return occurrences;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PDL1Package.WORK_DEFINITION__OCCURRENCES:
