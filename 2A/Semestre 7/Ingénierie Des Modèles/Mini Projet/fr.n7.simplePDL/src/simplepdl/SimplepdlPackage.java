...
public interface SimplepdlPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int WORK_DEFINITION__OCCURRENCE = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int RESSOURCE__OCCURRENCE = PROCESS_ELEMENT_FEATURE_COUNT + 2;
	...
	/**
	 * The meta object id for the '{@link simplepdl.impl.OccurrenceImpl <em>Occurrence</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see simplepdl.impl.OccurrenceImpl
	 * @see simplepdl.impl.SimplepdlPackageImpl#getOccurrence()
	 * @generated
	 */
	int OCCURRENCE = 6;
	 ...
	 * @ordered
	 */
	int OCCURRENCE__WORK_DEFINITION = 2;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link simplepdl.WorkDefinition#getOccurrence <em>Occurrence</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EReference getWorkDefinition_Occurrence();
	...
	/**
	 * Returns the meta object for the reference list '{@link simplepdl.Ressource#getOccurrence <em>Occurrence</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EReference getRessource_Occurrence();

	/**
	 * Returns the meta object for class '{@link simplepdl.Occurrence <em>Occurrence</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Occurrence</em>'.
	 * @see simplepdl.Occurrence
	 * @generated
	 */
	EClass getOccurrence();

	/**
	 * Returns the meta object for the attribute '{@link simplepdl.Occurrence#getOccurrence <em>Occurrence</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Occurrence</em>'.
	 * @see simplepdl.Occurrence#getOccurrence()
	 * @see #getOccurrence()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link simplepdl.Occurrence#getRessource <em>Ressource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Ressource</em>'.
	 * @see simplepdl.Occurrence#getRessource()
	 * @see #getOccurrence()
	 * @generated
	 */
	EReference getOccurrence_Ressource();

	/**
	 * Returns the meta object for the container reference '{@link simplepdl.Occurrence#getWorkDefinition <em>Work Definition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Work Definition</em>'.
	 * @see simplepdl.Occurrence#getWorkDefinition()
	 * @see #getOccurrence()
	 * @generated
	 */
	EReference getOccurrence_WorkDefinition();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference WORK_DEFINITION__OCCURRENCE = eINSTANCE.getWorkDefinition_Occurrence();
		 ...
		 * @generated
		 */
		EReference RESSOURCE__OCCURRENCE = eINSTANCE.getRessource_Occurrence();

		/**
		 * The meta object literal for the '{@link simplepdl.impl.OccurrenceImpl <em>Occurrence</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see simplepdl.impl.OccurrenceImpl
		 * @see simplepdl.impl.SimplepdlPackageImpl#getOccurrence()
		 ...
		 * @generated
		 */
		EReference OCCURRENCE__RESSOURCE = eINSTANCE.getOccurrence_Ressource();
		 ...
		 * @generated
		 */
		EReference OCCURRENCE__WORK_DEFINITION = eINSTANCE.getOccurrence_WorkDefinition();
