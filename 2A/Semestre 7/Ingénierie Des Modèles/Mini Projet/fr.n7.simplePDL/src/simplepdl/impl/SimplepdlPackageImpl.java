...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 */
	@Override
	public EReference getWorkDefinition_Occurrence() {
	 ...
	 */
	@Override
	public EReference getRessource_Occurrence() {
	 ...
	 */
	@Override
	public EAttribute getOccurrence_Occurrence() {
	 ...
	 */
	@Override
	public EReference getOccurrence_Ressource() {
	 ...
	 */
	@Override
	public EReference getOccurrence_WorkDefinition() {
	...
	public void createPackageContents() {
		...
		createEReference(workDefinitionEClass, WORK_DEFINITION__OCCURRENCE);
		...
		createEReference(ressourceEClass, RESSOURCE__OCCURRENCE);

		occurrenceEClass = createEClass(OCCURRENCE);
		createEAttribute(occurrenceEClass, OCCURRENCE__OCCURRENCE);
		createEReference(occurrenceEClass, OCCURRENCE__RESSOURCE);
		createEReference(occurrenceEClass, OCCURRENCE__WORK_DEFINITION);
	...
	public void initializePackageContents() {
		...
		initEReference(getWorkDefinition_Occurrence(), this.getOccurrence(), this.getOccurrence_WorkDefinition(), "occurrence", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRessource_Occurrence(), this.getOccurrence(), this.getOccurrence_Ressource(), "occurrence", null, 0, -1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(occurrenceEClass, Occurrence.class, "Occurrence", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getOccurrence_Occurrence(), ecorePackage.getEInt(), "occurrence", null, 1, 1, Occurrence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOccurrence_Ressource(), this.getRessource(), this.getRessource_Occurrence(), "ressource", null, 1, 1, Occurrence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOccurrence_WorkDefinition(), this.getWorkDefinition(), this.getWorkDefinition_Occurrence(), "workDefinition", null, 1, 1, Occurrence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
