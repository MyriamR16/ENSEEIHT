 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getOccurrence <em>Occurrence</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	public EList<Occurrence> getOccurrence() {
		if (occurrence == null) {
			occurrence = new EObjectContainmentWithInverseEList<Occurrence>(Occurrence.class, this, SimplepdlPackage.WORK_DEFINITION__OCCURRENCE, SimplepdlPackage.OCCURRENCE__WORK_DEFINITION);
		}
		return occurrence;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__OCCURRENCE:
