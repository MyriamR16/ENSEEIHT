 ...
 *   <li>{@link simplepdl.WorkDefinition#getOccurrence <em>Occurrence</em>}</li>
 * </ul>
 *
...
public interface WorkDefinition extends ProcessElement {
	 ...
	 * The list contents are of type {@link simplepdl.Occurrence}.
	 * It is bidirectional and its opposite is '{@link simplepdl.Occurrence#getWorkDefinition <em>Work Definition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Occurrence</em>' containment reference list.
	 * @see simplepdl.SimplepdlPackage#getWorkDefinition_Occurrence()
