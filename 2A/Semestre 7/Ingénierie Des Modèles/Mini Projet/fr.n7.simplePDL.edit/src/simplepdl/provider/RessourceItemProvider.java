	...
	protected void addOccurrencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_occurrence_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_occurrence_feature", "_UI_Ressource_type"),
				 SimplepdlPackage.Literals.RESSOURCE__OCCURRENCE,
				 true,
				 false,
				 true,
				 null,
