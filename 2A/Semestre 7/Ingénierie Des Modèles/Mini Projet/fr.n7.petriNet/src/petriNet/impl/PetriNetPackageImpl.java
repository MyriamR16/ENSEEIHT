...
public class PetriNetPackageImpl extends EPackageImpl implements PetriNetPackage {
	 ...
	 */
	@Override
	public EReference getNet_Noeud() {
	 ...
	 */
	@Override
	public EReference getNoeud_Entrant() {
	 ...
	 */
	@Override
	public EReference getNoeud_Sortant() {
	 ...
	 */
	@Override
	public EReference getNoeud_Net() {
	...
	public void createPackageContents() {
		...
		createEReference(netEClass, NET__NOEUD);

		noeudEClass = createEClass(NOEUD);
		createEAttribute(noeudEClass, NOEUD__NAME);
		createEReference(noeudEClass, NOEUD__ENTRANT);
		createEReference(noeudEClass, NOEUD__SORTANT);
		createEReference(noeudEClass, NOEUD__NET);
	...
	public void initializePackageContents() {
		...
		initEReference(getNet_Noeud(), this.getNoeud(), this.getNoeud_Net(), "noeud", null, 0, -1, Net.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getNoeud_Entrant(), this.getArc(), this.getArc_Destination(), "entrant", null, 0, -1, Noeud.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNoeud_Sortant(), this.getArc(), this.getArc_Source(), "sortant", null, 0, -1, Noeud.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNoeud_Net(), this.getNet(), this.getNet_Noeud(), "net", null, 1, 1, Noeud.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getArc_Destination(), this.getNoeud(), this.getNoeud_Entrant(), "destination", null, 1, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArc_Source(), this.getNoeud(), this.getNoeud_Sortant(), "source", null, 1, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getArc_LinkType(), this.getArcType(), "linkType", null, 1, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
